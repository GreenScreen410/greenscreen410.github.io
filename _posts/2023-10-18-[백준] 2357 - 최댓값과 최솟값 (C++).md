---
title: "[백준] 2357 - 최댓값과 최솟값 (C++)"
date: 2023-10-18 14:50:59 +0900
...
10868을 풀 때 사용하던 코드에서, 최댓값을 구해주는 함수 `initMax`와 `queryMax`를 만들어 주었습니다. 최솟값과 최댓값 결과 두 개를 모두 저장해야 하므로 pair를 사용하였습니다.
